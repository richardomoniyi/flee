        ...
        >
          ...
          >
            <input
              ...
              name="firstname"
              id="firstname"
              onChange={(element) => setDriverFirstName(element.target.value)}
            />
            <input
              type="text"
              placeholder="Last Name"
              ...
              name="lastname"
              id="lastname"
              onChange={(element) => setDriverLastName(element.target.value)}
            />
            <input
              type="text"
              placeholder="Email"
              ...
              name="email"
              id="email"
              onChange={(element) => setDriverEmail(element.target.value)}
            />
            <input
              type="text"
              placeholder="Phone"
              ...
              name="phone"
              id="phone"
              onChange={(element) => setDriverPhone(element.target.value)}
            />
             <textarea
              placeholder="Address"
              className="input input-bordered w-full"
              ...
              id="address"
              onChange={(element) =>
                setDriverNextKinAddress(element.target.value)
              }
            />
            <label className="form-control w-full">
              <div className="label">
                <span className="label-text">Pick a Driver photo</span>
              </div>
              <input
                type="file"
                className="file-input file-input-bordered w-full"
            ...
            <input
              ...
              id="nextkin"
              onChange={(element) =>
                setDriverNextKinFullname(element.target.value)
              }
            />
            <textarea
              placeholder="Address"
            ...
            <input
              ...
              id="nextkinemail"
              onChange={(element) =>
                setDriverNextKinEmail(element.target.value)
              }
            />
            </div>
